...
I've now got all image assets prepared for the existing controversy card collection, and the next step will be to populate three S3 buckets with these assets.
